						...
						<div class="row merged20" id="page-contents">
							...
							<div class="col-lg-12">
										...
										<div class="row">
											<div class="col-lg-6">
												<div class="align-left">
													<h5>Friend / Followers <span id="num-friend">0</span></h5>
												</div>
											</div>
											<div class="col-lg-6">
								...
								<div class="central-meta padding30">
									<div class="row merged20" id="list-friend">
...
<script>
    ...
    $.ajax({
        type: 'GET',
        url: 'http://localhost/social-media/controller/userrelacontroller/getbyid.php?id=1',
        headers:{
        ...
        success: function (response) {
            ...
            if(response.data == null) {
                ...
                $str = response.data.map(function (user) {
