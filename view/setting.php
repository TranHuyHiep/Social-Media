											...
											<div class="tab-content">
												...
												<div class="tab-pane fade" id="edit-profile" >
													...
													<div class="stg-form-area">
														<form method="post" class="c-form" action="../controller/usercontroller/login_api.php?action=updateuserinfo">
															<div>
															...
															<div>
																...
																<input type="text"  name="study_at">
															</div>
															<div>
																<label>Làm việc tại</label>
																<input type="text"  name="working_at">
															</div>
															<div>
